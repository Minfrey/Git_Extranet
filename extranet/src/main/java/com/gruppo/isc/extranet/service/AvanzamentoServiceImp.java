...
public class AvanzamentoServiceImp implements AvanzamentoService 
{
	...
	public String setAvanzamento(Avanzamento a)
	{
		...
		for(int i=0;i<list.size();i++)
		{
			...
			if(a.getAttivita().getCommessa().getId_commessa().equals(avanzamento.getAttivita().getCommessa().getId_commessa()) && a.getTipoAvanzamento().getId_tipo_avanzamento().equals(avanzamento.getTipoAvanzamento().getId_tipo_avanzamento()) && a.getAttivita().getId_attivita().equals(avanzamento.getAttivita().getId_attivita()) && a.getMese().getId_mese().equals(avanzamento.getMese().getId_mese()))
			{
